...
Running it from this folder instead: install Python 3 (python.org, tick "Add python.exe to
PATH"), double-click START HERE.bat, and the same page opens at http://127.0.0.1:8127/kit.html
